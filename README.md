...
Со погодување на буква од зборот корисникот добива поени кои се постојано видливи за него/неа, ако погреши се цртаат деловите од човекот во левиот панел. Ако сите делови на човекот се исцртани се испишува порака и играта завршувa, тајмерот се ресетира како и поените се враќаат на 0. Потоа, процедурата е иста.

![Game over screen](/screens/game_over.png)
